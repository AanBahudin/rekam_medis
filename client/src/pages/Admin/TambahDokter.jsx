...
export const action = async({request}) => {
  ...
  try {
    await customFetch.post('/dokter', data)
...
const TambahDokter = () => {
  ...
  return (
    <Form method="POST" className='w-full h-full overflow-y-auto p-10'>
       <h1 className='text-slate-700 font-semibold text-3xl flex items-center justify-between w-full cursor-default'>Tambah Tenaga Kesehatan</h1>
       ...
       <article className='w-full grid grid-cols-12 mt-10'>
        ...
        <div className='col-span-5 w-full flex flex-col items-center'>
          ...
          <img src={selectedImage || man} className='w-28 h-28 object-cover rounded-full' />
